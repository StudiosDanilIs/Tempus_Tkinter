...
def mostrar_opcion5(self):
    ...
    self.info_frame.place(x=125, y=15, width=805, height=600)
...
def mostrar_informacion(self, opcion):
    ...
    if opcion == "Agregar Usuario":
        ...
        self.frame_lista = Frame(self.info_frame, bg="#DCEBFF", colormap="new")
        self.frame_lista.place(x=0, y=55, width=805, height=360)    
        # Configuración del estilo
        style = ttk.Style()
        style.theme_use("default")
        style.configure(
        ...
        self.nombre_label.place(x=0, y=485)
        ...
        self.nombre_entry.place(x=0, y=515)
        ...
        self.nombre_label.place(x=235, y=485)
        ...
        self.nombre_entry.place(x=235, y=515)
        ...
        self.nombre_label.place(x=470, y=485)
        ...
        self.nombre_entry.place(x=470, y=515)
        ...
        self.modificar_clientes_button.place(x=0, y=565)
        
        titel_label = tk.Label(
            self.info_frame,
            text="Válido para pedidos",
            fg="#1778FB",
            bg="#f0f0f0",
            font=("Poppins", 15, "bold"),
        )
        titel_label.place(x=485, y=570)
        ...
        titel_label = tk.Label(
            self.info_frame,
            text="Valido para ventas y reparaciones",
            fg="#1778FB",
            bg="#f0f0f0",
            font=("Poppins", 15, "bold"),
        )
        titel_label.place(x=350, y=570)